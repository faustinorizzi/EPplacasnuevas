RENDER_VERSION = "GENERAL-A-LAB-COMPAT-01D"
GENERAL_A_EXPERIMENT_MODE = "doble"  # "base" | "corte" | "doble"
...
def build_general_a(title, description, image_data, section_label, logo_data):
    if GENERAL_A_EXPERIMENT_MODE == "corte":
        return build_general_a_corte(title, image_data, logo_data)
    if GENERAL_A_EXPERIMENT_MODE == "doble":
        return build_general_a_doble(title, image_data, logo_data)
    return build_general_a_base(title, image_data, logo_data)


def build_general_a_base(title: str, image_data: str, logo_data: str):
    photo_style = (
...
def build_general_a_corte(title: str, image_data: str, logo_data: str):
    photo_style = (
        f"background-image: url('{image_data}');"
        if image_data
        else "background: linear-gradient(135deg, #2d572c 0%, #183624 100%);"
...
def build_general_a_doble(title: str, image_data: str, logo_data: str):
    photo_style = (
        f"background-image: url('{image_data}');"
        if image_data
        else "background: linear-gradient(135deg, #2d572c 0%, #183624 100%);"
